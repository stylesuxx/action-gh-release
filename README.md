...
| `sequential_upload`              | Boolean | Upload sequentially instead of concurrently - this might fix rate limiting issues when uploading lots of release files it                                                                                                                                                                                                                                                                                                                                                                                               |
| `print_debug`              | Boolean | Print debug messages such as rate limits it                                                                                                                                                                                                                                                                                                                                                                                               |
